...
def add_task():
    ...
    new_tasks = {"name": tasks_chore, "completed": False}
    tasks.append(new_tasks)

def remove_tasks():
    remove_tasks = int(input("Please enter the number of the task to be removed:"))
    tasks.remove(tasks[remove_tasks])
    
def complete_tasks():
    list_tasks()
    complete_tasks = int(input("Please enter the number of the chore you completed:"))
    tasks[complete_tasks]["complete"] = True
